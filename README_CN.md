...
> **版本**: V7.1 | **类型**: 网页文字冒险游戏 | **状态**: 可玩

## 🎮 项目简介

**BreakingRich** 是一款基于DeepSeek AI驱动的富豪人生模拟文字冒险游戏。玩家从意外获得1亿元彩票大奖开始，通过各种选择体验富豪人生的起伏跌宕。

### 核心特色
- 🤖 **AI智能剧情**: 基于DeepSeek/OpenAI API的智能剧情生成
- 💰 **真实财富模拟**: 涵盖房地产、奢侈品、投资、消费等经济活动
...
### 在线访问
将项目部署到静态网页托管服务（GitHub Pages、Vercel等）即可在线访问。
